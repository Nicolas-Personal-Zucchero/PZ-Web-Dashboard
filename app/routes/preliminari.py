...
def preliminari():
    ...
    for s in spedizioni:
        ...
        for i in s.identificativi_rel:
            if not i.fattura_identificativo:
                continue
                
            identificativo = i.fattura_identificativo.strip()
            ...
            all_identificativi.add(identificativo)
...
def invia():
    ...
    spedizioni = SpedizionePreliminare.query.filter(SpedizionePreliminare.id.in_(spedizioni_ids)).all()
